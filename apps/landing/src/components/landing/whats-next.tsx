        ...
        <Reveal delay={120}>
          <div className="glass-panel relative flex flex-col items-start gap-6 overflow-hidden rounded-3xl px-8 py-10 sm:flex-row sm:items-center sm:justify-between">
            ...
            <Link
              ...
              className="group relative inline-flex h-12 shrink-0 items-center gap-2 rounded-full bg-accent px-6 text-[14px] font-semibold text-navy transition-colors hover:bg-teal"
            >
              Explore Compliance
