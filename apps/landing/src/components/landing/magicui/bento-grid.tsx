  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <span
          className={`flex items-center justify-center rounded-2xl bg-accent/10 text-accent ${
      ...
      <span className="relative mt-5 inline-flex items-center gap-1 text-[13px] font-medium text-accent-dim">
        {cta}
