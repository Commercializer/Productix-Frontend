...
export const metadata: Metadata = {
  title: "GS1 Digital Link Platform | Product Identity & 2D Barcodes | Productix",
  description:
      ...
      <DetailSection bg="cream" flip>
        ...
        <Reveal delay={120} className="mt-10 flex justify-center">
          <Link
            ...
            className="group inline-flex items-center gap-1.5 text-[14px] font-semibold text-accent-dim transition-colors hover:text-accent"
          >
