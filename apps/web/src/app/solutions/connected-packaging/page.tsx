...
export const metadata: Metadata = {
  title: "Connected Packaging Platform | Digital Product Experiences",
  description:
      ...
      <DetailSection bg="cream" flip>
        ...
        <Reveal delay={150} className="mt-10 flex justify-center">
          <Link
            ...
            className="group inline-flex items-center gap-1.5 text-[14px] font-semibold text-brand-accent-dim transition-colors hover:text-ink"
          >
