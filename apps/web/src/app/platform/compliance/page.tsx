...
export const metadata: Metadata = {
  title: "Product Compliance & Packaging Data Platform",
  description:
      ...
      <DetailSection bg="white">
        ...
        <Reveal delay={150} className="mt-12 flex justify-center">
          <div className="glass-light flex flex-col items-center gap-4 rounded-3xl px-8 py-8 text-center">
            ...
            <CalButton className="inline-flex h-11 items-center rounded-full bg-brand-accent px-6 text-[14px] font-semibold text-navy transition-colors hover:bg-teal">
