  ...
  return (
    <section id="builder" className="relative overflow-hidden bg-cream px-6 py-24 md:py-28">
      ...
      <Reveal delay={100} className="relative mx-auto mt-16 max-w-6xl">
        <div
          className="pointer-events-none absolute -inset-16 -z-10 rounded-[3rem] bg-linear-to-br from-brand-accent/25 via-sky/15 to-transparent blur-3xl"
          aria-hidden="true"
        />
      ...
      >
        {BUILDER_FEATURES.map((item) => (
          ...
          >
            <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-brand-accent/10 text-brand-accent">
