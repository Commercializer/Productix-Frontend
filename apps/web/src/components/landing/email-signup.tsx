    ...
    <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-2 sm:max-w-sm">
      <div className="flex gap-2">
        ...
        <input
          ...
          className="h-11 flex-1 rounded-full border border-ink/15 bg-white/70 px-4 text-[13.5px] text-ink placeholder:text-ink/40 focus:border-brand-accent focus:outline-none"
        />
        <button
          type="submit"
      ...
      {error && (
        <p id="footer-email-error" className="text-[12px] text-brand-accent-dim">
          {error}
        </p>
      )}
    </form>
